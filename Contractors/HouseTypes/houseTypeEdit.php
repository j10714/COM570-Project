      ...
      <div class="row">
        <main role="main" class="col-sm-9 ml-sm-auto col-md-10 pt-3">
          ...
          <h2>Section title</h2>
			...
			<?php
				$dbQuery=$db->prepare("select * from development WHERE developmentID=:id");
				$dbParams=array('id'=>$developmentID1);
				$dbQuery->execute($dbParams);
			
				while ($dbRow = $dbQuery->fetch(PDO::FETCH_ASSOC)) 
				{
					$developmentID=$dbRow["developmentID"];
					$developmentName=$dbRow["developmentName"];
					$developmentAddress=$dbRow["developmentAddress"];
					$developmentPlots=$dbRow["developmentPlots"];
					$devlopmentStatus=$dbRow["devlopmentStatus"];
					$developmentCity=$dbRow["developmentCity"];
					$developmentState=$dbRow["developmentState"];
					$developmentPostcode=$dbRow["developmentPostcode"];
				}
